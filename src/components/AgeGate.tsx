...
export default function AgeGate({ children }: Props) {
  ...
  return (
    <>
      <div className="fixed inset-0 z-[100] bg-[#1a1a1a]/40 backdrop-blur-md flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white border border-[#ececec] rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] overflow-hidden">
          <div className="p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-11 h-11 rounded-xl bg-[#fff7ed] border border-[#fed7aa] flex items-center justify-center shrink-0">
                <ShieldAlert size={20} className="text-[#ea580c]" />
              </div>
              <div>
                <p className="text-[#ea580c] text-[10px] font-bold tracking-[0.25em] uppercase mb-0.5">
                  {pl ? 'Weryfikacja wieku' : es ? 'Verificación de edad' : 'Age Verification'}
                </p>
                <h2 className="text-[#0a0a0a] text-lg font-extrabold leading-tight">
            ...
            <p className="text-[#525252] text-sm leading-relaxed mb-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5">
              ...
              <button
                onClick={decline}
                className="flex-1 bg-white border border-[#ececec] text-[#525252] font-medium py-3 rounded-xl hover:border-[#d4d4d4] transition-all text-sm"
              >
                {pl ? 'Wyjdź' : es ? 'Salir' : 'Exit'}
              </button>
            </div>

            <p className="text-[#a3a3a3] text-[10px] text-center mt-5 leading-relaxed">
