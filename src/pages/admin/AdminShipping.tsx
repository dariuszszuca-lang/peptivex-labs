        ...
        <div className="bg-[#fafaf7] border border-[#ececec] rounded-xl p-5">
          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <input placeholder="Z panelu manager.paczkomaty.pl" className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-3 py-2 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
              <label className="text-[#737373] text-xs uppercase tracking-wide mb-1 block">API Token</label>
              <input type="password" placeholder="Token z InPost API" className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-3 py-2 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
        ...
        <div className="bg-[#fafaf7] border border-[#ececec] rounded-xl p-5">
          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <input type="password" placeholder="Token z developers.inpost.co.uk" className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-3 py-2 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <button className="bg-[#fff7ed] text-[#ea580c] border border-[#fed7aa] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#fff7ed] transition-colors">
              Połącz
            </button>
