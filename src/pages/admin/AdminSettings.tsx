      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-[#fafaf7] border border-[#ececec] rounded-xl p-6">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input defaultValue="PEPTIVEX LABS" className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
              <label className="text-[#737373] text-xs uppercase tracking-wide mb-1.5 block">Email kontaktowy</label>
              <input defaultValue="info@peptivexlabs.com" className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
        ...
        <div className="bg-[#fafaf7] border border-[#ececec] rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" defaultValue={1299} className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
              <label className="text-[#737373] text-xs uppercase tracking-wide mb-1.5 block">PL — free od (grosze)</label>
              <input type="number" defaultValue={50000} className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
              <label className="text-[#737373] text-xs uppercase tracking-wide mb-1.5 block">UK — koszt (pence)</label>
              <input type="number" defaultValue={766} className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
            <div>
              <label className="text-[#737373] text-xs uppercase tracking-wide mb-1.5 block">UK — free od (pence)</label>
              <input type="number" defaultValue={10000} className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500/40 focus:outline-none" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#fafaf7] border border-[#ececec] rounded-xl p-6">
          ...
          <div>
            ...
            <input type="password" placeholder="re_..." className="w-full bg-[#fafaf7] border border-[#ececec] rounded-lg px-4 py-2.5 text-white text-sm font-mono focus:border-amber-500/40 focus:outline-none" />
          </div>
        </div>
