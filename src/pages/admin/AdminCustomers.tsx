          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#ececec]">
                ...
                <th className="text-left text-[#737373] text-xs uppercase tracking-wide px-4 py-3">Kontakt</th>
                <th className="text-left text-[#737373] text-xs uppercase tracking-wide px-4 py-3">Zamówienia</th>
                <th className="text-left text-[#737373] text-xs uppercase tracking-wide px-4 py-3">Łącznie</th>
                <th className="text-left text-[#737373] text-xs uppercase tracking-wide px-4 py-3">Pierwsze</th>
                <th className="text-left text-[#737373] text-xs uppercase tracking-wide px-4 py-3">Ostatnie</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map(c => (
                <tr key={c.email} className="border-b border-white/[0.03] hover:bg-[#fafaf7]">
                  ...
                  <td className="px-4 py-3">
                    ...
                    {c.phone && (
                      <a href={`tel:${c.phone}`} className="text-[#737373] hover:text-[#ea580c] text-xs flex items-center gap-1.5 mt-1">
                        <Phone size={12} /> {c.phone}
                      </a>
                    )}
                  </td>
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center gap-1.5 bg-[#fff7ed] text-[#ea580c] text-xs px-2 py-1 rounded-full font-medium">
                  ...
                  <td className="px-4 py-3 text-[#737373] text-xs whitespace-nowrap">{formatDate(c.firstOrder)}</td>
                  <td className="px-4 py-3 text-[#737373] text-xs whitespace-nowrap">{formatDate(c.lastOrder)}</td>
                </tr>
              ))}
            </tbody>
          </table>
