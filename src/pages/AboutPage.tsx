    ...
    <div>
      ...
      <div className="relative z-10 -mt-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="stats-bar bg-white/95 backdrop-blur-xl border border-amber-500/10 rounded-2xl p-6 grid grid-cols-2 sm:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center">
                <p className="text-[#ea580c] text-3xl font-extrabold mb-1">{s.value}</p>
                <p className="text-[#737373] text-xs uppercase tracking-wide">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden border border-[#ececec] shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                <img src="/images/products/retatrutide-box-holo.jpg" alt="PEPTIVEX LABS" className="w-full aspect-[4/5] object-cover" />
              </div>
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-white border border-[#fed7aa] rounded-xl p-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
                <p className="text-[#ea580c] text-2xl font-extrabold">&gt;98%</p>
                <p className="text-[#737373] text-xs">{pl ? 'Czystość HPLC' : es ? 'Pureza HPLC' : 'HPLC Purity'}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {timeline.map((step, i) => (
              <div key={i} className="relative group">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500/15 to-amber-500/5 border border-[#fed7aa] flex items-center justify-center mb-5 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] group-hover:scale-110 transition-all duration-300">
