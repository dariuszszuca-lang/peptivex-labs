...
export default function TermsPage() {
  ...
  const sections = pl ? [
    ...
    { title: '3. Zamówienia i płatności', text: 'Zamówienia można składać przez stronę internetową 24/7. Płatności realizowane są przez certyfikowanego operatora płatności online z szyfrowaniem PCI DSS. Akceptujemy: Pay by Bank (przelew bankowy online), BLIK, karty płatnicze (Visa, Mastercard), Apple Pay i Google Pay. Zamówienie zostaje przyjęte do realizacji po zaksięgowaniu płatności.' },
    ...
    { title: '3. Orders and Payments', text: 'Orders can be placed through the website 24/7. Payments are processed by a certified online payment service provider with PCI DSS encryption. We accept: Pay by Bank (instant bank transfer), BLIK, credit/debit cards (Visa, Mastercard), Apple Pay and Google Pay. Orders are processed after payment confirmation.' },
    ...
    <div>
      ...
      <div className="relative overflow-hidden py-16">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          <h1 className="text-[#0a0a0a] text-3xl font-extrabold">{pl ? 'Regulamin' : es ? 'Términos y Condiciones' : 'Terms & Conditions'}</h1>
        </div>
      </div>
