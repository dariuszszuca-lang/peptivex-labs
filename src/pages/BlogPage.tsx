        ...
        <div className="flex flex-col gap-6">
          {BLOG_POSTS.map(post => (
            <Link
              ...
              className="group bg-[#fafaf7] border border-[#ececec] rounded-xl overflow-hidden hover:border-[#fed7aa] transition-all flex flex-col sm:flex-row"
            >
              {/* Thumbnail */}
              ...
              <div className="p-6 flex flex-col justify-between flex-1">
                ...
                <span className="text-[#ea580c] text-sm flex items-center gap-1 mt-4 group-hover:gap-2 transition-all">
